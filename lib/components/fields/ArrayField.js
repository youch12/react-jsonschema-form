          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("span", {
                ...
                onClick: function onClick(e) {
                  e.stopPropagation();
                  _this4.props.onEditClicked(_this4.props);
                }
              })
            )
          )
  ...
  _createClass(ArrayField, [{
      ...
      var arrayProps = {
        ...
        items: formData.map(function (item, index) {
          ...
          return _this6.renderArrayFieldItem({
            ...
            onBlur: onBlur,
            onFocus: onFocus,
            onEditClicked: _this6.props.onEditClicked
          });
        }),
    ...
    value: function renderFixedArray() {
      ...
      var _props6 = this.props,
          ...
          onEditClicked = _props6.onEditClicked,
      ...
      var arrayProps = {
        ...
        items: items.map(function (item, index) {
          ...
          return _this7.renderArrayFieldItem({
            ...
            onBlur: onBlur,
            onFocus: onFocus,
            onEditClicked: _this7.props.onEditClicked
          });
        }),
        onAddClick: this.onAddClick,
        readonly: readonly,
